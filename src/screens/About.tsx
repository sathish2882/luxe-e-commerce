  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about Luxe, an ecommerce platform offering premium electronics, fashion, and lifestyle products with a seamless shopping experience."
        />
      </Helmet>
      <section className="my-15 px-8 sm:px-10 xl:px-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-gray-600 leading-relaxed">
              We focus on quality, reliability, and style to ensure every
              product you purchase delivers great value. With secure checkout,
              fast delivery, and a user-friendly interface, Luxe makes online
