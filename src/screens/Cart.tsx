  ...
  return (
     <section className="my-10 px-8 sm:px-10 xl:px-20">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 h-fit border border-1 border-gray-300">
          ...
          <button onClick={handleCheckout} className="w-full mt-4 bg-[var(--secondary-color)] text-white py-2 rounded-2xl hover:bg-orange-400 transition font-semibold cursor-pointer">
            Checkout
          </button>
