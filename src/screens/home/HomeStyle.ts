...
export const exploreBtn = "rounded-3xl w-[110px] bg-[#fff] h-[45px] text-[#000] border border-1 border-gray-300 mb-5 cursor-pointer"
...
export const CardAddToCart = "absolute left-1/2 w-[80%] -translate-x-1/2 bottom-0 opacity-0 bg-[var(--secondary-color)] text-white px-4 py-2 rounded-md flex items-center justify-center gap-2 transition-all duration-300 group-hover:bottom-5 group-hover:opacity-100 cursor-pointer shadow-lg shadow-black/70 h-10"
